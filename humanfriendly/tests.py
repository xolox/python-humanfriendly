...
class HumanFriendlyTestCase(TestCase):
    ...
    def test_ansi_style(self):
        ...
        assert ansi_style(bold=True) == '{}1{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(faint=True) == '{}2{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(italic=True) == '{}3{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(underline=True) == '{}4{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(inverse=True) == '{}7{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(strike_through=True) == '{}9{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(color='blue') == '{}34{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(background='blue') == '{}44{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(color='blue', bright=True) == '{}94{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(color=214) == '{}38;5;214{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(background=214) == '{}39;5;214{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(color=(0, 0, 0)) == '{}38;2;0;0;0{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(color=(255, 255, 255)) == '{}38;2;255;255;255{}'.format(ANSI_CSI, ANSI_SGR)
        assert ansi_style(background=(50, 100, 150)) == '{}48;2;50;100;150{}'.format(ANSI_CSI, ANSI_SGR)
